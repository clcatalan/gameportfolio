...
public class TextController : MonoBehaviour {
    ...
    private enum States {
        ...
        ,stairs_1, courtyard, floor, corridor_1, corridor_2, corridor_3, closet_door, in_closet};
    ...
    void cell()
    { //state when youre in the cell

        text.text = "You are in a prison cell and you want to escape. " +
               "There are dirty sheets on the bed, a mirror on the wall, and the door" +
    ...
    void mirror()
    { //state when you can take the mirror

        text.text = "That Mirror looks a bit loose from the wall \n\n"+
    ...
    { //state when you can take the mirror
        ...
        text.text = "You are in a prison cell and you STILL want to escape. " +
               "There are dirty sheets on the bed, and the pesky door " +
    ...
    { //state when youre in the cell
        ...
        text.text = "The Sheets are pretty dirty, It's time somebody should change them \n\n"+
    ...
    { //state when youre in the cell
        ...
        text.text = "Holding a mirror in your wand wont make the sheets look better \n\n" +
               "Press R to Return to roaming your cell";
        if (Input.GetKeyDown(KeyCode.R))    { myState = States.cell_mirror; }
    }

    void lock_0()
    { //state when you view up the lock

        text.text = "You have no idea what the combination is for this lock "+
            "You wish you could somehow see where the fingerprints were, maybe that would help. \n\n"+
    ...
    { //state when you view up the lock
        ...
        text.text = "You carefully put the mirror through the bars so you could see the lock " +
            "You can see the fingerprints in the buttons. You press them and hear a click \n\n" +
            "Press O to Open or Press R to Return roaming to your cell";
